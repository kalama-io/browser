...
readonly BROWSER_EXTENSION_DIR="${HOME}/Library/Application Support/Kalama/Default/cyfs_extensions"
readonly BROWSER_OLD_EXTENSION_DIR="${HOME}/Library/Application Support/Kalama/Extensions"
